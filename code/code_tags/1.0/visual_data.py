...
head = ["序号","转债名称","转债代码","股票名称","股票代码","所属行业","转债价格","涨跌_1",
        "盘中套","股价","涨跌_2","转债成交额","转债换手率","转股价格","P/B","股价/转股价","转股价值","转股溢价率",
...
p1.circle("bond_price", "a", color={'field': 'credit', 'transform': color_mapper}, size=10, alpha=0.6,source=source)
...
# 转债价格与转股价格
p2 = figure(title="转债价格-到期收益率",tooltips=TOOLTIPS,**options)
p2.circle("bond_price", "b", color={'field': 'credit', 'transform': color_mapper}, size=10, alpha=0.6,source=source)
